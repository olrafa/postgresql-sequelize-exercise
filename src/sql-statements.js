...
// Kept receiving authentication errors for my user (rafael) when using Pool. Decided to continue with Client, because I couldn't really understand where it came from.
...
client.connect()
   ...
   .then(() => client.query('UPDATE person SET eye_color = \'blue\' WHERE eye_color = \'brown\''))
